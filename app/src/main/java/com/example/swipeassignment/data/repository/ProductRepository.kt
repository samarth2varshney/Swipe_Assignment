...
class ProductRepository(private val apiService: ProductApiService) {
    ...
    suspend fun uploadProduct(product: Product,image: MultipartBody.Part?): Resource<ResponseBody> {
        return try {
            ...
            val response = apiService.addProduct(nameBody, typeBody, priceBody, taxBody, image)
